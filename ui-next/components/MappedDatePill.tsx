...
export function MappedDatePill({ value }: { value: string }) {
  ...
  return (
    <button
      type="button"
      onClick={openPicker}
      className="relative inline-flex items-center gap-2 px-3.5 py-2  text-[13px] font-semibold border border-[#F59E0B] bg-[#FFF4ED] text-[#EA580C] hover:bg-white transition-all cursor-pointer"
    >
